...
<html lang="pt-br">
  ...
  <body>
          ...
          <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
              <ul class="navbar-nav d-flex align-items-center">
                  ...
                  <li class="nav-item active">
                      <a class="btn btn-warning mb-3 ml-3" href="sobre.php">SOBRE</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="justify-content-center">
                      <a href="Cadastrar.php" class="nav-link mb-3 ml-3" role="button">CADASTRO</a>
                  </li>
                  <li>
                      <a href="login.php" class="nav-link mb-3 ml-3" role="button" data-toggle="modal"
    ...
    <div id="carouselExampleIndicators" class="carousel slide .d-none .d-lg-block .d-xl-nonek" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img class="d-block w-100" src="imagem\GYM.jpg" alt="Primeiro Slide">
            </div>
            <div class="carousel-item">
            <img class="d-block w-100" src="imagem\GYM2.jpg" alt="Segundo Slide">
            </div>
        </div>
