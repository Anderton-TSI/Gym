      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link mb-3 ml-3" href="index.php">INICIO<span class="sr-only">(Página atual)</span></a>
          </li>
          <li class="nav-item">
          ...
          <li>
              <a href="login.php" class="btn btn-warning mb-3 ml-3" href="#" role="button">LOGIN</a>
          </li>
          <nav class="nav-link mb-3 ml-3">
            <a class="navbar-brand" href="https://www.instagram.com/gymoficialapp/">
              <img src="https://cdn2.iconfinder.com/data/icons/harmonicons-04/64/instagram-512.png" width="30" height="30" alt="Instagram">
            </a>
          </nav> 
        </ul>
      </nav>
        ...
        <div class="card">
          ...
          <div class = "card-body">
            <form class="form-group" action="autenticar_usuario.php" method="POST">
                ...
                <input type="email" class="form-control" id="email" name="email" aria-describedby="email" placeholder="Informe seu E-mail: ">
